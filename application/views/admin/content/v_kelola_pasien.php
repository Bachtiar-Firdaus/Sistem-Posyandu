...
<button class="btn btn-success" onclick="add_m_kd()"><i class="glyphicon glyphicon-plus"></i> TAMBAH PASIEN</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('admin_controller/ajax_list1')?>",
            "type": "POST"
        },
...
function edit_m_kd(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('admin_controller/ajax_edit1')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('admin_controller/ajax_add1')?>";
    } else {
        url = "<?php echo site_url('admin_controller/ajax_update1')?>";
    }
...
function delete_m_kd(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('admin_controller/ajax_delete1')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
            ...
            <div class="modal-body form">
                ...
                <div class="form-group" >
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input name="no" placeholder="MAUKAN NIK" class="form-control" type="number">
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input name="tanggal" placeholder="masukan TANGGAL" class="form-control" type="date">
                                <span class="help-block"></span>
                            </div>
                        </div>
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input name="nohp" placeholder="masukan NO HP" class="form-control" type="number">
                                <span class="help-block"></span>
                            </div>
                        </div>
                       ...
                       <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <input name="umur_b" placeholder="masukan UMUR BULAN" class="form-control" type="number">
                                <span class="help-block"></span>
                            </div>
                        </div>
