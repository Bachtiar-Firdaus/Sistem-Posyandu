...
<form method="post" accept-charset="utf-8" action="<?php echo base_url()?>index.php/c_laporan/cetak">
    <div class="form-group">

        <div  style="width: 180px; float: left;">
            <input name="tanggal" placeholder="tanggal" value="masukan tanggal" type="date" style="  float: left; width: 167px; margin: 5px; border-radius: 5px; height: 35px;px;">
        </div>
