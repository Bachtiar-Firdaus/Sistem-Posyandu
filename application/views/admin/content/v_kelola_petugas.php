        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                ...
                <div class="form-group" >
                       ...
                       <div class="form-group">
                            <label class="control-label col-md-4" style="text-align: left;"> USER</label>
                            <div class="col-md-7">
                                <input name="user" placeholder="masukan USER" class="form-control" type="text">
                       ...
                       <div class="form-group">
                            <label class="control-label col-md-4" style="text-align: left;"> LEVEL</label>
                            <div class="col-md-7">
                            <select name = "level" class="form-control" >
                                <option>KMS</option>
                                <option>KADER-PENDAFTARAN</option>
                            </select>
                                <span class="help-block"></span>
                            </div>
                        </div>
                       ...
                       <div class="form-group">
                            <label class="control-label col-md-4" style="text-align: left;"> NOHP</label>
                            <div class="col-md-7">
                                <input name="nohp" placeholder="masukan NOHP" class="form-control" type="NUMBER">
                                <span class="help-block"></span>
                            </div>
                        </div>
